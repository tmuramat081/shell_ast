...
/*   Updated: 2023/02/22 00:19:00 by kkohki           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 
 * @return t_ast_node* Pointer to root node.
 */
t_ast_node	*ast_node_create(void);

/**
 * @brief Create a new node with left/right child node.
 * 
 * @param left 
 * @param right 
 * @return t_ast_node* 
...
/**
 * @brief Create a new node for commands, with argument and redirect list.
 * 
 * @return t_command* 
 */
...
/**
 * @brief Create a new node for arguments list.
 * 
 * @param word 
 * @param type 
 * @return t_argument* 
...
/**
 * @brief Create a new node for redirects list.
 * 
 * @param type 
 * @param fd 
 * @param file 
